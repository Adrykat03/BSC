create PROCEDURE [Avisos].[pa_trabajadoresHorariosCostoHorario05092022]
...
BEGIN
	...
	BEGIN TRY
		...
		; WITH CTE_DatosHorario (cco, fecha, cant_horarios, cant_calculohorarios)
		AS
		(
		...
		BEGIN
			SET @consulta = N'SELECT cadena, cco, descripcion, fecha, cant_asociados, cant_horarios, cant_calculosHorarios
    ...
    BEGIN CATCH
		...
		-- INSERT notificación consolidada
		INSERT INTO Avisos.notificacionesConsolidadas (estado, origen, spOrigen, asunto, descripcionHtml, destinatarios, periodoInicio, periodoFin)
		VALUES ('A', 'Horarios', 'pa_trabajadoresHorariosCostoHorario05092022', 'ERROR en Alerta - asociados, horarios y costo de horario', @HTML, 'pasante.nominadosec@kfc.com.ec', @fecha_ini, @fecha_fin);
		EXEC msdb.dbo.sp_send_dbmail 
			@profile_name='Informacion_Nomina',
			--@recipients= 'pasante.nominadosec@kfc.com.ec', 
			@recipients= 'sabrina.chinchin@kfc.com.ec; dennis.suarez@gmail.com; jimmy.cazaro@kfc.com.ec; pasante.nominadosec@kfc.com.ec', 
