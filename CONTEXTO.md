...
|----|--------|--------|-------|
| FUNC-000 | Estructura base del proyecto | Pendiente | - |
...
- **Backend:** Solucion .sln, proyectos API/Application/Domain/Infrastructure, configuracion MongoDB, middleware base.
- **Frontend:** Proyecto Vite + React, integracion del design system, layout principal (sidebar + header), routing base.
- **Security:** Pendiente revision inicial.
